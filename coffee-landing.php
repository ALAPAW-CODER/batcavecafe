...
<head>
    ...
    <script>
        window.chtlConfig = {
            chatbotId: "8595759578"
        }
    </script>
    <script async data-id="8595759578" id="chtl-script" type="text/javascript" src="https://chatling.ai/js/embed.js"></script>
    <script>
            ...
            <div class="login-modal-content privacy-modal-content">
                ...
                <div class="login-modal-body privacy-modal-body">
                    ...
                    <div class="privacy-intro">
                        ...
                        café, make reservations, order for pickup, or use our services.<br><br>
